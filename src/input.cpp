...
void DecayKeyboardState(KeyBoardState* kbs) {
    static enum KeyboardKeyState to_depressed_state[KeyboardKeyState_COUNT] = {
        KeyboardKeyState_Depressed, KeyboardKeyState_Depressed, KeyboardKeyState_Held,
...
bool IsNewlyPressed(KeyboardKeyState state) { return state == KeyboardKeyState_Pressed; }
