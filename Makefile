...
EXE = TOOMED
IMGUI_DIR = src/imgui
SOURCES = src/toomed.cpp src/assets_exporter.cpp src/assets_importer.cpp src/delaunay_mesh.cpp src/game_map.cpp src/geometry_utils.cpp src/input.cpp src/math_utils.cpp src/palette.cpp
...
OBJS = obj/toomed.o obj/assets_exporter.o obj/assets_importer.o obj/delaunay_mesh.o obj/game_map.o obj/geometry_utils.o obj/input.o obj/math_utils.o obj/palette.o
